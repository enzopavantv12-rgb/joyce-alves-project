...
export const CircularTestimonials = ({
  ...
  return (
    <div className="w-full max-w-[56rem] mx-auto p-4 md:p-8">
      <div className="grid md:grid-cols-2 gap-12 md:gap-20">
        {/* Images */}
        <div className="relative w-full h-80 md:h-96" style={{ perspective: "1000px" }} ref={imageContainerRef}>
        ...
        <div className="flex flex-col justify-between">
          <AnimatePresence mode="wait">
            ...
            >
              <h3
                className="font-bold mb-1 font-display"
                style={{ color: colorName, fontSize: fontSizeName }}
              >
                {activeTestimonial.name}
              </h3>
              <p
                className="mb-8 font-body uppercase tracking-wider"
                style={{ color: colorDesignation, fontSize: fontSizeDesignation }}
              >
                {activeTestimonial.designation}
              </p>
              <motion.p
                className="leading-[1.75] font-body"
